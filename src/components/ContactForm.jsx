...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      aria-label="Send a message to Abdullah Ibn Yousuf"
    >
      <div style={{ textAlign: 'left', borderBottom: '1px solid var(--border-primary)', paddingBottom: '16px' }}>
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0 }}>
          Tell me about your project, internship, or collaboration opportunity.
        </p>
      </div>
      ...
      {status === 'success' && (
        ...
        >
          Thank you! Your message was sent successfully. Abdullah will respond as soon as possible.
        </div>
      )}
      ...
      {status === 'error' && (
        ...
        >
          Something went wrong. Please try again or email directly at abdullahibnyousuf@outlook.com
        </div>
      )}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', textAlign: 'left' }}>
        ...
        >
          ...
          <option value="Backend or API Development">Backend or API Development</option>
          <option value="AI-Assisted Application">AI-Assisted Application</option>
          <option value="Automation or Internal Tool">Automation or Internal Tool</option>
          <option value="Internship or Collaboration">Internship or Collaboration</option>
        </select>
      </div>
