...
const BALLOON_CONFIG = [
    ...
    { texture: '/textures/about/threejsduzybalon.webp', paintedTexture: '/textures/about/threejsduzybalon_painted.webp', label: 'TypeScript', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/GSAPduzybalon.webp', paintedTexture: '/textures/about/GSAPduzybalon_painted.webp', label: 'Python', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - scattered around
    { texture: '/textures/about/JSSREDNIBALON.webp', paintedTexture: '/textures/about/JSSREDNIBALON_painted.webp', label: 'Node.js', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/textures/about/csssrednibalon.webp', paintedTexture: '/textures/about/csssrednibalon_painted.webp', label: 'FastAPI', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    ...
    { texture: '/textures/about/figmamalybalon.webp', paintedTexture: '/textures/about/figmamalybalon_painted.webp', label: 'REST APIs', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/firebasemalybalon.webp', paintedTexture: '/textures/about/firebasemalybalon_painted.webp', label: 'RAG Workflows', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            <Text
                ...
                font="/fonts/CabinSketch-Regular.ttf"
            >
                Technologies I use to build practical products
            </Text>
