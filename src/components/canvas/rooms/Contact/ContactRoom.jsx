    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="GITHUB"
                onClick={() => window.open('https://github.com/AbdullahIbnYousuf', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/abdullahibnyousuf/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* FACEBOOK */}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.location.href = 'mailto:abdullahibnyousuf@outlook.com'}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
