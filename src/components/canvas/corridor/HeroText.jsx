...
/**
 * HeroText Component - Custom styled for Abdullah
 */
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ABDULLAH split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.75, splitDir: -2.1 },
        { char: 'B', baseX: -1.25, splitDir: -1.5 },
        { char: 'D', baseX: -0.75, splitDir: -0.9 },
        { char: 'U', baseX: -0.25, splitDir: -0.3 },
        { char: 'L', baseX: 0.25, splitDir: 0.3 },
        { char: 'L', baseX: 0.75, splitDir: 0.9 },
        { char: 'A', baseX: 1.25, splitDir: 1.5 },
        { char: 'H', baseX: 1.75, splitDir: 2.1 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: 'Computer Science', baseX: -1.45, splitDir: -1.8 },
        { text: 'Student', baseX: -0.45, splitDir: -0.6 },
        { text: 'Software & AI', baseX: 0.55, splitDir: 0.6 },
        { text: 'Developer', baseX: 1.45, splitDir: 1.8 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of ABDULLAH
