...
export default function Contact() {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText('abdullahibnyousuf@outlook.com');
    setCopied(true);
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-gradient-purple">Useful Together.</span>
            </h2>
            <p
              style={{
                fontSize: '1.1rem',
            ...
            >
              I am open to internships, selected freelance projects, and collaborations involving practical software, backend systems, AI-assisted applications, and full-stack products.
            </p>
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                <a
                  href="mailto:abdullahibnyousuf@outlook.com"
                  style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '20px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  <a
                    href="https://github.com/AbdullahIbnYousuf"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/abdullahibnyousuf/"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}
                    className="contact-item-hover"
                  ...
                  <a
                    ...
                    style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}
                    className="contact-item-hover"
                    aria-label="Email Abdullah Ibn Yousuf"
                  >
                    Email
                  </a>
                </div>
