        ...
        <div className="hero-content-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left', maxWidth: '720px' }}>
            ...
            >
              ...
              Open to internships, selected freelance projects, and collaborations
            </div>
            ...
            >
              Building Practical Software for Real Problems.
            </h1>
            ...
            >
              I build practical software, AI-assisted applications, and full-stack systems that turn real problems into usable products.
            </p>
